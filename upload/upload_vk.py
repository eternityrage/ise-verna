...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 Isellas Verenna Daily!\n\n#isellasverenna"
        ...
        video = upload.video(
            ...
            name=title or 'Isellas Verenna Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "Isellas Verenna"
