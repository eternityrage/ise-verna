...
def main():
    ...
    title = "Isellas Verenna Daily"
    description = "#shorts #isellasverenna"
    tags = ['couture', 'fashion', 'beauty', 'lifestyle', 'glamour', 'luxury', 'redcarpet', 'style', 'isellasverenna', 'ootd', 'skincare', 'selfcare', 'inspiration', 'liveglamorously']
